...
<section>
    ...
    <table>
        ...
        <?php foreach($matches as $match):?>
            <tr>
                <td><?= (new DateTime($match['match-date']))->format('M jS, Y');?></td>
...
<section>
    ...
    <form action="manage.php" method="post">
        ...
        <input type="text" id="match-date" name="match-date" placeholder="<?= NOW;?>" value="<?=(!isset($_POST['match-date'])) ? NOW : $_POST['match-date'];?>">
        <br>
